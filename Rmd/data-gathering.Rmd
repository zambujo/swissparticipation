...
Horizon Dashboard is built using the Qlik Sense App: data need to be downloaded by hand.  They contain useul attributes which are missing in the CORDIS records. (manual data export via Qlik Sense App)
...
# TODO: add country data from 
# TODO: https://cordis.europa.eu/data/reference/cordisref-countries.csv
# TODO: instead of the countrycode package
