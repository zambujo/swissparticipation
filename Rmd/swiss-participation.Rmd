...
The [**Horizon 2020 Dashboard**](https://webgate.ec.europa.eu/dashboard) project data was last updated 2021-12-06.  The data contains 176,512 rows with the following details on every participant on each project:
...
![](../data/treemap.svg "A treemap of EU H2020 contribution to Swiss participants, by pillar and thematic priority.")