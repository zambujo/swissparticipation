...
```{r download-cordis-data, eval=FALSE}
# TODO: update main text
...
ch_res %>%
  ...
  labs(
    title = "EU Contribution to Research and HigherEd: Distribution Over Time",
    subtitle = glue(
      "Comparing <span style='color:{pal[1]};'>Switzerland</span> ",
      "to the <span style='color:{pal[2]};'>Remaining Countries</span>"),
    x = "Call Semester",
    y = "%"
  ) +
