...
```{r ch-type, fig.asp=.5, fig.retina=TRUE}
df %>%
  filter(country_code == "CH") %>%
  mutate(
    pillar_abbr = str_replace(pillar_abbr, fixed("Cross-theme"), "Other"),
  ...
  labs(
    title = "Pillar 1 is the primary source of funding for CH",
    subtitle = "Swiss R&Education organisations received a high share",
    x = "Pillar",
